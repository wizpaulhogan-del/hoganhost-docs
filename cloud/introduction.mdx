...
-   **`image`** – The operating system or application image installed.  
    See [Available Images](#available-images).
...
| `wordpress-php8-22-04` | WordPress on Ubuntu 22.04 (x64) |

> ℹ️ **Note**: Marketplace app slugs may vary. Use the Images API for the most up-to-date list.
